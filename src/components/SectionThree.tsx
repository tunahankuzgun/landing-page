        ...
        <div className="flex flex-row justify-between">
          <div>
            ...
            <div className="flex gap-[50px] mt-[60px]">
              <div className="w-[50px] bg-white rounded-full h-[50px] flex items-center justify-center border-[1px] border-color1">
                <svg
                  width="22"
                  height="16"
                  viewBox="0 0 22 16"
              ...
              <div className="rotate-180 w-[50px] bg-white rounded-full h-[50px] flex items-center justify-center border-[1px] border-color1">
                <svg
                  width="22"
                  height="16"
                  viewBox="0 0 22 16"
          ...
          <div className=" mt-[160px]">
            <div className="w-[500px] flex shadow-section3Shadow h-[358px] rounded-[30px] mb-[104px] z-10 relative">
              ...
              <div className="flex ml-[30px] h-full justify-center flex-col gap-[14px]">
                <div className=" w-0 h-[37px] border-[2px] border-textColor3 rounded-full" />
                <div className=" w-0 h-[37px] border-[2px] border-textColor4 rounded-full opacity-50" />
                <div className=" w-0 h-[37px] border-[2px] border-textColor4 rounded-full opacity-50" />
              </div>
            </div>
          </div>
