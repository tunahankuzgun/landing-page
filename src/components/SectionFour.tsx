      ...
      <div className="relative w-full max-w-[1160px] mx-auto max-lg:max-w-full">
        <div className="flex flex-row justify-between max-lg:flex-col max-lg:justify-center max-lg:items-center max-lg:w-full">
          <div className="mt-[82px] max-w-[285px] text-textColor2 max-lg:max-w-full max-lg:justify-center max-lg:mt-[60px] ">
            <div className="flex h-[50px] gap-2 items-center max-lg:w-full max-lg:justify-center">
              <div className="w-[50px] h-[50px] rounded-full items-center flex justify-center bg-primaryColour">
                ...
                >
                  <path
                    d="M23.715 9.16502L12.465 0.16502C12.332 0.0585172 12.1667 0.000488281 11.9963 0.000488281C11.8258 0.000488281 11.6605 0.0585172 11.5275 0.16502L0.2775 9.16502C0.156135 9.26239 0.0680565 9.39509 0.025468 9.54474C-0.0171205 9.69439 -0.0121105 9.85359 0.0398037 10.0003C0.091718 10.1469 0.187966 10.2738 0.315214 10.3634C0.442461 10.4529 0.594407 10.5007 0.75 10.5H2.25V23.25C2.25 23.4489 2.32902 23.6397 2.46967 23.7803C2.61032 23.921 2.80109 24 3 24H18V22.5H15V15.75C15 15.5511 14.921 15.3603 14.7803 15.2197C14.6397 15.079 14.4489 15 14.25 15H9.75C9.55109 15 9.36032 15.079 9.21967 15.2197C9.07902 15.3603 9 15.5511 9 15.75V22.5H3.75V10.5H16.5V9.00002H2.8875L12 1.71002L21.1125 9.00002H21C20.8011 9.00002 20.6103 9.07904 20.4697 9.21969C20.329 9.36034 20.25 9.55111 20.25 9.75002V14.25H21.75V10.5H23.25C23.405 10.4991 23.5558 10.4503 23.6819 10.3601C23.8079 10.27 23.903 10.1431 23.9539 9.99673C24.0049 9.8504 24.0093 9.69187 23.9665 9.54294C23.9237 9.39401 23.8359 9.26198 23.715 9.16502ZM10.5 16.5H13.5V22.5H10.5V16.5Z"
                    fill="white"
                  />
                  <path
                    d="M18.75 19.9426L17.7825 18.9751L16.725 20.0326L18.225 21.5326C18.3655 21.6723 18.5556 21.7507 18.7537 21.7507C18.9519 21.7507 19.142 21.6723 19.2825 21.5326L23.7825 17.0326L22.725 15.9751L18.75 19.9426Z"
                    fill="white"
                  />
                </svg>
              </div>
            ...
            <div className="mt-[30px] gap-[10px] items-center flex max-lg:w-full max-lg:justify-center max-lg:mt-5">
              ...
              <button>
                <h5 className=" hover:underline font-medium">mail@mail.com</h5>
              </button>
            </div>
          </div>
          <div className="mt-[100px] mb-[105px] max-w-[134px] text-textColor2 max-lg:mb-0 max-lg:hidden">
            ...
            <nav className="mt-[40px] h-[161px] text-[16px] font-normal leading-[26px] text-left">
          ...
          <div className="mt-[100px]  max-w-[106px] text-textColor2 max-lg:hidden">
            ...
            <nav className="mt-[40px] h-[131px] text-[16px] font-normal leading-[26px] text-left">
              <ul className="space-y-2">
                <li>
                  <a href="#canada" className="hover:underline">
                    Canada
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#africa" className="hover:underline">
                    Africa
                  </a>
                </li>
                <li>
